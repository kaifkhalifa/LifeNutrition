...
def recommend_food(user_id):
    ...
    for food in recommended_foods:
        score = (
            (food.calories - remaining_calories) ** 2 +
            (food.protein - remaining_protein) ** 2 +
            (food.fat - remaining_fat) ** 2 +
            (food.carbohydrates - remaining_carbohydrates) ** 2
        )
...
def recommend():
    ...
    return render_template('recommend.html', recommended_foods=recommended_foods)
